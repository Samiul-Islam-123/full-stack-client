                            ...
                            firstPart ? (<>
                                ...
                                <Button
                                    onClick={async () => {
                                        ...
                                        const res = await axios.post(`${process.env.REACT_APP_API_URL}/authentication/request-password-reset`, {
                                            email: email
                                        })
                                ...
                                <Button
                                    onClick={async () => {
                                        setIsLoading(true);
                                        //perform api request
                                        const res = await axios.post(`${process.env.REACT_APP_API_URL}/authentication/verify`, {
                                            email: email,
                                            otp: OTP
                                        })
                                        if (res.data.message == "OK")
